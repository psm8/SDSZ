...
/*walls with windows*/
public class IrregularCuboid extends Cuboid {
    private final List<Cuboid> windows;

    public IrregularCuboid(double temperatureInside, double temperatureOutside, List<Layer> layers, double windVelocity,
